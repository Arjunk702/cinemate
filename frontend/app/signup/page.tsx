...
export default function SignupPage() {
  ...
  const handleGoogleAuth = useGoogleLogin({
    onSuccess: async (tokenResponse) => {
      try {
        ...
        alert("Google Signup Success! See console.");
      } catch (err) {
  ...
  useEffect(() => {
    ...
    let frame = 0;
    let lastTime = 0;
    const fps = 20; // Default playback speed
          ...
          <div className="px-8 pt-8 pb-7">
            ...
            <form className="space-y-4">
              ...
              <div className="group">
                <label
                  htmlFor="username"
                  className="flex items-center gap-2 text-[10px] font-mono tracking-[0.18em] uppercase text-white/25 mb-1.5"
                >
                ...
                <input
                  ...
                  className="w-full bg-white/[0.03] border border-white/[0.09] text-white text-sm px-4 py-2.5 outline-none placeholder:text-white/[0.12] placeholder:font-mono placeholder:text-xs transition-all duration-150 focus:border-violet-500/60 focus:bg-violet-500/[0.05] hover:border-white/20"
                />
              </div>
              ...
              <div className="group">
                ...
                <input
                  ...
                  placeholder="••••••••"
                  className="w-full bg-white/[0.03] border border-white/[0.09] text-white text-sm px-4 py-2.5 outline-none placeholder:text-white/20 transition-all duration-150 focus:border-violet-500/60 focus:bg-violet-500/[0.05] hover:border-white/20"
                />
              </div>
              ...
              <div className="pt-4">
                <button
                  type="submit"
                  className="group/btn relative w-full overflow-hidden bg-violet-500 hover:bg-violet-400 active:scale-[0.99] transition-all duration-150 px-4 py-3.5"
                >
